      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              <button type="button" aria-label="Telegram" onClick={() => toast(`Telegram — ${t('coming_soon')}`, { icon: '🔗' })} className="w-10 h-10 bg-slate-900 light:bg-white border border-slate-800 light:border-slate-200 hover:border-indigo-500 text-slate-400 light:text-slate-500 hover:text-white light:hover:text-slate-800 rounded-xl flex items-center justify-center transition-all duration-300 shadow-sm cursor-pointer">
                <MessageCircle className="w-5 h-5" />
              </button>
              <button type="button" aria-label="Instagram" onClick={() => toast(`Instagram — ${t('coming_soon')}`, { icon: '🔗' })} className="w-10 h-10 bg-slate-900 light:bg-white border border-slate-800 light:border-slate-200 hover:border-indigo-500 text-slate-400 light:text-slate-500 hover:text-white light:hover:text-slate-800 rounded-xl flex items-center justify-center transition-all duration-300 shadow-sm cursor-pointer">
              ...
              <button type="button" aria-label="Github" onClick={() => toast(`Github — ${t('coming_soon')}`, { icon: '🔗' })} className="w-10 h-10 bg-slate-900 light:bg-white border border-slate-800 light:border-slate-200 hover:border-indigo-500 text-slate-400 light:text-slate-500 hover:text-white light:hover:text-slate-800 rounded-xl flex items-center justify-center transition-all duration-300 shadow-sm cursor-pointer">
              ...
              <button type="button" aria-label="Youtube" onClick={() => toast(`Youtube — ${t('coming_soon')}`, { icon: '🔗' })} className="w-10 h-10 bg-slate-900 light:bg-white border border-slate-800 light:border-slate-200 hover:border-indigo-500 text-slate-400 light:text-slate-500 hover:text-white light:hover:text-slate-800 rounded-xl flex items-center justify-center transition-all duration-300 shadow-sm cursor-pointer">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 light:text-slate-600 text-sm transition-colors">
              <li><button type="button" onClick={() => toast(`${t('footer_designs')} — ${t('coming_soon')}`, { icon: '📦' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_designs')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_ebooks')} — ${t('coming_soon')}`, { icon: '📦' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_ebooks')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_code')} — ${t('coming_soon')}`, { icon: '📦' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_code')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_licenses')} — ${t('coming_soon')}`, { icon: '📦' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_licenses')}</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400 light:text-slate-600 text-sm transition-colors">
              <li><button type="button" onClick={() => toast(`${t('footer_about')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_about')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_terms')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_terms')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_privacy')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_privacy')}</button></li>
              <li><button type="button" onClick={() => toast(`${t('footer_faq')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-white light:hover:text-slate-950 transition-colors cursor-pointer text-left">{t('footer_faq')}</button></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-900 light:border-slate-200 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 light:text-slate-600 transition-colors">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <button type="button" onClick={() => toast(`${t('footer_support')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-slate-300 light:hover:text-slate-850 transition-colors flex items-center gap-1 cursor-pointer">
              <HelpCircle className="w-3.5 h-3.5" />
              {t('footer_support')}
            </button>
            <button type="button" onClick={() => toast(`${t('footer_payment')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-slate-300 light:hover:text-slate-850 transition-colors cursor-pointer">{t('footer_payment')}</button>
            <button type="button" onClick={() => toast(`${t('footer_warranty')} — ${t('coming_soon')}`, { icon: 'ℹ️' })} className="hover:text-slate-300 light:hover:text-slate-850 transition-colors cursor-pointer">{t('footer_warranty')}</button>
          </div>
        </div>
      </div>
    </footer>
