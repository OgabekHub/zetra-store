          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            {cartItems.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                <div className="w-16 h-16 bg-slate-800/50 rounded-2xl flex items-center justify-center border border-slate-700/50 text-slate-500">
                  <ShoppingBag className="w-8 h-8" />
                </div>
                <div>
                  <h3 className="font-semibold text-lg">Savat bo'sh</h3>
                  <p className="text-slate-500 text-sm mt-1">Hozircha hech narsa qo'shmadingiz</p>
                </div>
                <button 
                  onClick={onClose}
